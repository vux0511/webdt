                            ...
                            <div class="row social-buttons">
                                ...
                                <div class="col-xs-4 col-sm-4 col-md-12">
                                    <a href="#" class="btn btn-block btn-twitter">
                                        <i class="fa fa-twitter"></i> <span class="hidden-xs hidden-sm">Đăng nhập với Twitter</span>
                                    </a>
                                </div>
                                <div class="col-xs-4 col-sm-4 col-md-12">
                                    ...
                                    <form name="loginForm" class="loginForm" action="#" method="POST">
                                        ...
                                        <div class="row remember-row">
                                            <div class="col-xs-6 col-sm-6">
                                                    ...
                                                    <span class="label-text">Nhớ tài khoản</span>
                                                </label>
                                            </div>
                                            <div class="col-xs-6 col-sm-6">
                                                <p class="forgotPwd">
                                        ...
                                        <!-- ./remember-row -->
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-lg btn-primary btn-block" name="login">Đăng Nhập</button>
                                        </div>
                                    </form>
                                </div>
                            </div>

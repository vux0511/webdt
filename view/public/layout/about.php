    ...
    <div class="container">
        <div class="row" style="margin: 70px 0px;">
            <div class="col-md-6 col-xs-6">
                <img src="https://blog.ugreen.com/wp-content/uploads/2020/10/iphone-12-banner-1.png" height="400px" width="100%">
            </div>
            <div class="col-md-6 col-xs-6" style="margin: 10px auto;">
                <h2 style="font-size: 38px; font-weight: 600;">Giới thiệu về VT-Phone</h2>
                <p style="font-size: 16px; color: #353535; line-height: 1.7;">Những năm qua, chúng tôi không ngừng cải thiện dịch vụ tại các chi nhánh và hỗ trợ khách hàng qua các kênh online. VT-Phone cam kết mang đến những sản phẩm chất lượng và chế độ bảo hành uy tín, sẵn sàng hỗ trợ khách hàng trong thời
                    gian nhanh nhất. <br> <br> Trong tương lai, VT-Phone sẽ tiếp tục mở rộng hệ thống chi nhánh, hướng tới mục tiêu có mặt tại 63 tỉnh thành trên toàn quốc. Đồng thời, nâng cao chất lượng dịch vụ, hạn chế những rủi ro, lắng nghe
                    và tiếp thu góp ý của quý khách hàng nhằm đem đến trải nghiệm tốt nhất khi mua sắm tại VT-Phone. </p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 col-xs-4" style="margin-bottom: 20px;">
                <div class="col-md-2 col-xs-2">
                    <i class="fas fa-mobile-alt" style="font-size: 38px;"></i>
                </div>
                <div class="col-md-10 col-xs-10">
                    <h3 style="font-size: 25px; margin-top: 0px; color: #1c1c1c;">Hàng chính hãng</h3>
                    <p style="font-size: 15px; padding-top: 5px; color: #1c1c1c;">Chúng tôi đảm bảo cung cấp cho khách hàng 100% hàng chính hãng , đảm bảo chất lượng , uy tín</p>
                </div>
            </div>
            <div class="col-md-4 col-xs-4" style="margin-bottom: 20px;">
                <div class="col-md-2 col-xs-2">
                    <i class="fab fa-hotjar" style="font-size: 38px;"></i>
                </div>
                <div class="col-md-10 col-xs-10">
                    <h3 style="font-size: 25px; margin-top: 0px; color: #1c1c1c;">Sản phẩm mới 100%</h3>
                    <p style="font-size: 15px; padding-top: 5px; color: #1c1c1c;">Những sản phẩm ở cửa hàng chúng tôi đảm bảo mới 100% để giúp khách hàng có trải nghiệm tốt nhất</p>
                </div>
            </div>
            <div class="col-md-4 col-xs-4" style="margin-bottom: 20px;">
                <div class="col-md-2 col-xs-2">
                    <i class="fas fa-tools" style="font-size: 38px;"></i>
                </div>
                <div class="col-md-10 col-xs-10">
                    <h3 style="font-size: 25px; margin-top: 0px; color: #1c1c1c;">Bảo hành 12 tháng</h3>
                    <p style="font-size: 15px; padding-top: 5px; color: #1c1c1c;">Bảo hành sản phẩm trong vòng trong 12 tháng đầu , giúp khách hàng yên tâm sử dụng</p>
                </div>
            </div>
            <div class="col-md-4 col-xs-4" style="margin-bottom: 20px;">
                <div class="col-md-2 col-xs-2">
                    <i class="fas fa-history" style="font-size: 38px;"></i>
                </div>
                <div class="col-md-10 col-xs-10">
                    <h3 style="font-size: 25px; margin-top: 0px; color: #1c1c1c;">Đổi trả trong vòng 7 ngày</h3>
                    <p style="font-size: 15px; padding-top: 5px; color: #1c1c1c;">Cho phép khách hàng đổit rả sản phẩm trong 7 ngày đầu sử dụng</p>
                </div>
            </div>
            <div class="col-md-4 col-xs-4" style="margin-bottom: 20px;">
                <div class="col-md-2 col-xs-2">
                    <i class="fas fa-shipping-fast" style="font-size: 38px;"></i>
                </div>
                <div class="col-md-10 col-xs-10">

                    <h3 style="font-size: 25px; margin-top: 0px; color: #1c1c1c;">Miễn phí giao hàng</h3>
                    <p style="font-size: 15px; padding-top: 5px; color: #1c1c1c;">Miễn phí phí vận chuyển sản phẩm cho khách hàng ở xa mua sản phẩm</p>
                </div>
            </div>
            <div class="col-md-4 col-xs-4" style="margin-bottom: 20px;">
                <div class="col-md-2 col-xs-2">
                    <i class="fas fa-hand-holding-usd" style="font-size: 38px;"></i>
                </div>
                <div class="col-md-10 col-xs-10">
                    <h3 style="font-size: 25px; margin-top: 0px; color: #1c1c1c;">Giá cả hợp lý</h3>
                    <p style="font-size: 15px; padding-top: 5px; color: #1c1c1c;">Giá cả hợp lý , giúp khách hàng dễ hàng sở hữu sản phẩm </p>
                </div>
            </div>
        </div>
    </div>